...
const database = async () => {
  try {
    ...
    let connectdb = await connect.db("Siddharth");
    console.log("Database is created");

    let collection = await connectdb.createCollection("Mobiles");
    ...
    //   let a1 = await collection.findOne({"id": "0CEPNRDV98KT3ORP"})
    //   console.log(a1)

    // collection.updateMany({},{$set : {bio : "MAHADEV"}})
